...
import { groupDiagnostics, parseCompilerOutput, presentDiagnostics } from "$lsp-server/diagnostics/adapter";
import { buildDiagnosticWithRange } from "$lsp-server/diagnostics/range";
import { buildRelatedInformation } from "$lsp-server/diagnostics/relatedInfo";
