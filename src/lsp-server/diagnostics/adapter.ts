...
import type { DiagnosticGroup, DiagnosticsPresentationSettings, ParsedDiagnostic, RenderedDiagnostic } from "$lsp-server/diagnostics/types";
import {
  type CoreDiagnosticGroup,
  type CoreDiagnosticSeverity,
  type CoreDiagnosticsPresentationSettings,
  type CoreParsedDiagnostic,
  type CoreRenderedDiagnostic,
