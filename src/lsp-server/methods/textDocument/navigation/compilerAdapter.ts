...
import { buildSymbolsArgs, runCompilerCommand, toDocumentFsPath } from "$lsp-server/methods/textDocument/navigation/compilerCommand";
...
import type { ParsedSymbolDumpEntry, SymbolsDefinitionQueryResult, SymbolsHoverQueryResult } from "$sac2c/interpret/symbols";
import { parseSymbolsOutput } from "$sac2c/interpret/symbols";
