...
import type { DiagnosticRelatedInformation, Location, Position } from "vscode-languageserver/node";

import type { ParsedDiagnostic } from "$lsp-server/methods/textDocument/diagnostics/types";
