...
import { extractCallExpressionSource } from "$extension/fallback/parser/navigation/callExpression";
import {
  getCandidateParameterShapes,
  getCandidateReturnShape,
  scoreShapeCompatibility,
  type ValueShape,
} from "$extension/fallback/parser/navigation/shapeScoring";
import type { NavigationIndex, NavigationSymbol, NavigationToken } from "$extension/fallback/parser/navigation/types";
