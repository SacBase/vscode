...
import type { HoverMatch, HoverTarget } from "$extension/fallback/parser/hover-info/types";
...
// Re-export hover documentation utilities from sub-modules
export { formatHoverDocumentationMarkdown, type HoverFormattingOptions } from "$extension/fallback/parser/hover-info/hoverDocFormatting";
export { resolveHoverDocumentation } from "$extension/fallback/parser/hover-info/hoverDocs";
